...
RRR1vs4_6
```
The risk ratio of being in household income category 1 (< 500) vs category 3 (1001-1500) for widowed women is 1.39 times that same risk ratio for legally/common-law married women, on average. 

The risk ratio of being in household income category 1 (< 500) vs category 5 (2001-2500) for widowed women is 1.76 times that same risk ratio for legally/common-law married women, on average. 

The risk ratio of being in household income category 1 (< 500) vs category 4 (1501 - 2000) for never married women is 2.9 times that same risk ratio for legally/common-law married women, on average. 
...
RRR1vs8
```
The relative risk ratio of being in household income category 1 (lowest) vs category 8 for HIV positive women is 1.448 that same risk as for non infected women.
...
```
We fail to reject the null hypothesis that the model without marital status is better (p-value < 0.05) and conclude that the model with marital status provides a better fit than the model with HIV status alone.
