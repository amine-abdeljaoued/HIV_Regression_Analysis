...
As for the logistic regression model with "high income" and "low income", most of our odds ratio's confidence intervals have their upper boundary lower than one. This confirms our previous sayings as this means that the odds of having a high income are higher for married women than women in other marital categories.
