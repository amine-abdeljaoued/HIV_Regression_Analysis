...
```
The data looks suitable for a Poisson regression model. However, we have a lot of missing data. Missing data fr this variable is encoded by a value of -1. From the Histogram we can see that this is the case for roughly 320 women in the study.
